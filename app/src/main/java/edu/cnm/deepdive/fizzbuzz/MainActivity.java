...
public class MainActivity extends AppCompatActivity {
  ...
  public boolean onOptionsItemSelected(MenuItem item) {
    Log.d("Trace", "Entering onOptionsItemSelect");
    ...
    Log.d("Trace", "Leaving onOptionsItemSelect");
    return handled;
  }
  ...
  private void resumeGame() {
    running = true;
    timer = new Timer();
    timer.schedule(new RandomValueTask(), 0, 3000);  //FIXME This should read preference.
    //TODO Update any necessary fields, timer, & menu.
    invalidateOptionsMenu();
  }
